...
if __name__ == "__main__":
    use_auth_token = sys.argv[1] # replace "xxx" with your access token (see https://huggingface.co/docs/hub/security-tokens and https://huggingface.co/settings/tokens)
